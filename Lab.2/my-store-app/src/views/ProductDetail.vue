<template>
  <div v-if="product" class="product-detail max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg">
    ...
    <p class="text-center text-blue-500 text-xl font-semibold mb-6">${{ product.price.toFixed(2) }}</p>
